function [completionFlag, ayprCmd] = bhv_hover_over_H_slam(stateEstimateMsg, ayprCmd, completion, bhvTime)
...
%Kx = 5/100; % was /5          % over 2m   Kx = 0.02/100
%Ky = 5/100;                   % over 2m   Ky = 0.02/100
...
% impulseDuration = 0.2;
% latchOnTime = 4.0; % sec
 satLimit = 0.25;                 % over 2m   satLimit = 0.1
...
%     end
% end
pitchDesired = -stateEstimateMsg.Pitch;
rollDesired =  -stateEstimateMsg.Roll;
