function varargout = Tuner_GUI(varargin)
% TUNER_GUI MATLAB code for Tuner_GUI.fig
%      TUNER_GUI, by itself, creates a new TUNER_GUI or raises the existing
%      singleton*.
%
%      H = TUNER_GUI returns the handle to a new TUNER_GUI or the handle to
%      the existing singleton*.
%
%      TUNER_GUI('CALLBACK',hObject,eventData,handles,...) calls the local
%      function named CALLBACK in TUNER_GUI.M with the given input arguments.
%
%      TUNER_GUI('Property','Value',...) creates a new TUNER_GUI or raises the
%      existing singleton*.  Starting from the left, property value pairs are
%      applied to the GUI before Tuner_GUI_OpeningFcn gets called.  An
%      unrecognized property name or invalid value makes property application
%      stop.  All inputs are passed to Tuner_GUI_OpeningFcn via varargin.
%
...
gui_State = struct('gui_Name',       mfilename, ...
                   ...
                   'gui_OpeningFcn', @Tuner_GUI_OpeningFcn, ...
                   'gui_OutputFcn',  @Tuner_GUI_OutputFcn, ...
                   'gui_LayoutFcn',  [] , ...
                   'gui_Callback',   []);
...
% --- Executes just before Tuner_GUI is made visible.
function Tuner_GUI_OpeningFcn(hObject, eventdata, handles, varargin)
...
% UIWAIT makes Tuner_GUI wait for user response (see UIRESUME)
% uiwait(handles.figure1);


% --- Outputs from this function are returned to the command line.
function varargout = Tuner_GUI_OutputFcn(hObject, eventdata, handles) 
