function [thrustCmd, altErrorHistory] = altitudeControllerPI(gains, altErrorHistory, curTime, zcur, zd, altControlDegbugPublisher)
...
minIntegralLimit = -0.5; % TODO: add as parameter
maxIntegralLimit = 0.5;
