function  [u_stick,psi_int,angdes,thrust_c] = accel2stick_wsc_CF(udes,zhat,psi_int,dt,params)
...
u_stick(4)= (psi_des - euler321(3))/12;%%psi/umax %%%max(-1,min(1,dpsi_c/dpsi_max));      % yaw, saturated
% ustick_out = u_stick
