...
tnow= 0;
tend= 15;%480; % (s)
OL_dt = 0.2/5; % Artificially prescribed time to run the outer loop
abort= 0;
...
if ii == 1
    position_raw = zeros(3,vIDs(inds));
    pos0 = position_raw(:,1);
...
%             u_stick{vID}(4)= 0;
        elseif tnow > tend && tnow < tend+2.7
            ...
            u_stick{vID}(1)= (delT_trim{vID}*2 - 1)*0.75;%0.95*(delT_trim{vID});%%
