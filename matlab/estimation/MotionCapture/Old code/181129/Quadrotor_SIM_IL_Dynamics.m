...
dt = 0.0025; % timestep for solver, plot % 0.08 seems to match real time
...
for ii = 1:(N-1)
    [time,z_indiv] = ode45(@eom, tspan(ii:ii+1), z0, options,...
                                    R_d_old,dt,Eb3_in,K_in,u_stick,disturbance);
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
function [zdot, M_B, OMGA, T, R_d, R_B] = eom(t, z,R_d_old,dt,Eb3_in,K_in,u_stick,disturbance)
