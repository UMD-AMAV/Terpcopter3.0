...
if SE3
    ...
    % rejection
    K_in(1) = 9; %0.67;
    K_in(2) = 3;%K_in(1)/1.5;%0.67;
    K_in(3) = 600;%150;
    K_in(4) = 120;%K_in(3)/2;%/8
else
    % CF Gains
    K_in(1) = 3; %0.67;
    K_in(2) = 2;%K_in(1)/3;%0.67;
    K_in(3) = 5;%150; Ki in cleanflight
    K_in(4) = 2;% Kp in cleanflight
    % Kd set to Ki/100
end
...
%         fprintf(sTrainerBox{vID},strCmd1);
        ...
        [t, position_raw, velocity, angle_raw, Rmat, omega_rate, R_d_old, ~, ~, paramCF] = ...
            Quadrotor_SIM_IL_Dynamics(strCmd1,IL_tspan,pos0,velocity0,...
                                      Rmat0,omega_rate0, R_d_old,paramQuad,K_in,paramCF,SE3);
...
plot(time, stick_input(:,2), 'linewidth', 2)
