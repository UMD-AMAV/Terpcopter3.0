...
%
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
function [t_out, position, velocity, angle, Rmat, omega_rate, R_d_old, Quat, IDs, paramCF] = ...
    Quadrotor_SIM_IL_Dynamics(TxInput,IL_tspan,pos0,vel0,Rmat0,omega_rate0, R_d_old, paramQuad, K_in, paramCF,SE3)
...
for ii = 1:(N-1)
    [time,z_indiv] = ode45(@eom, tspan(ii:ii+1), z0, options,...
                                    R_d_old,dt,Eb3_in,K_in,u_stick,disturbance,paramCF,SE3);
    ...
    [zdot(:,ii+1), M_B(:,ii+1), OMGA(:,ii+1), input_T(:,ii+1), R_d(:,:,ii+1), R_B(:,:,ii+1), paramCF]...
        = eom(time(end),z0,R_d_old,dt,Eb3_in,K_in,u_stick,disturbance,paramCF,SE3);
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
function [zdot, M_B, OMGA, T, R_d, R_B, paramCF] = eom(t, z,R_d_old,dt,Eb3_in,...
                                        K_in,u_stick,disturbance,paramCF,SE3)
...
% In body frame
F_D_frame = (1/2)*rho*sqrt(Bvinf.'*Bvinf)*Bvinf*Cd_frame*(0.2*0.1);
